...
export class DesafiosService {
    ...
    async criarDesafio(desafio: Desafio): Promise<Desafio> {
        try {
            ...
            /**
             * Quanto um desafio for criado, definimos o status
    ...
    async atualizarDesafio(_id: string, desafio: Desafio): Promise<void> {
        /**
         * Atualizaremos a data da responta quando o status do desafio
         * vier preenchido
         */
    ...
    async atualizarDesafioPartida(
        ...
        try {
            /**
             * Quando uma partida for registrada por un usúario, mudaremos o
